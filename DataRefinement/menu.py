...
def refinement_menu(mode):
    ...
    match(mode):
        ...
        case "coap":
            ...
            levels = ['ZMAP output dataset', 'experiment', 'partition']
            path = "IpScan/results_partitioned"

            file_path = files_handling.file_selection(levels, path)
            ...
            asyncio.run(coap.findCoapServers(file_path))
        ...
        case "ip":
            ...
            levels = ['ZMAP output dataset', 'experiment', 'date']
            path = "DataRefinement/results_partitioned"
            ...
            #   ALL available
            if (files_handling.allPartitionsDone(file_path) == True):
                
                # 3) find IP info
                ip.findIpInfo(file_path)
